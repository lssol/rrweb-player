    ...
    ***************************************************************************** */
    ...
    var Timer = (function () {
        ...
        Timer.prototype.start = function () {
            ...
            var self = this;
            function check(time) {
                var nextActionDelay = actions.length >= 2 ? actions[1].delay : time;
                var virtualTime = Math.min(time - lastTimestamp, nextActionDelay) * config.speed;
                lastTimestamp = time;
                self.timeOffset += virtualTime;
